...
export default function SignInWithLichessButton ({ className }: SignInWithLichessButtonProps) {
    return (
        <Link href={'/login/lichess'}>
                <Button
                  className={cn(`m-auto flex h-28 min-h-24 w-full max-w-[28rem] flex-none flex-col gap-2 px-1 font-bold`, className)}
                  variant="outline"
                >
