...
export default function ClubSettings({ selectedClub, userId }: ClubTabProps) {
  ...
  return (
    <section className="divide-ring max-md:p-mk top-20 right-0 left-0 m-auto flex min-h-[calc(100dvh-136px)] w-full max-w-[min(640px,100%)] flex-col justify-between p-0 max-sm:absolute">
