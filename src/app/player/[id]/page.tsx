...
import getPlayerQuery from '@/server/db/queries/get-player-query';
import getStatus from '@/server/db/db/queries/get-status-query';
import { getUserClubAffiliation } from '@/server/db/db/queries/get-user-club-affiliation';
import { StatusInClub } from '@/server/db/db/schema/clubs';
